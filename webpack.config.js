...
Encore
  ...
  .addEntry("about_js", "./assets/js/about.js")
  .addEntry("home_js", "./assets/js/home.js")
  .addEntry("reservation_js", "./assets/js/reservation.js")

  .addStyleEntry("global_styles", [
    "./assets/styles/normalize.css",
    "./assets/styles/app.css",
    "./assets/styles/components/loader.css",
    "./assets/styles/components/navbar.css",
    "./assets/styles/components/footer.css",
  ])
  .addStyleEntry("about_css", "./assets/styles/about.css")
  .addStyleEntry("confirmation_css", "./assets/styles/confirmation.css")
