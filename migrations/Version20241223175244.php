 ...
 */
final class Version20241223175244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, date_id INT NOT NULL, email VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, phone_number VARCHAR(255) DEFAULT NULL, seats INT NOT NULL, hour DATETIME NOT NULL, INDEX IDX_42C84955B897366B (date_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE seat (id INT AUTO_INCREMENT NOT NULL, reservation_date_id INT NOT NULL, hour DATETIME NOT NULL, seats_available INT NOT NULL, INDEX IDX_3D5C3666DF028DEE (reservation_date_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
